const BOOK_DATA = [
  {
    ...
    "entries": [
      ...
      },
      {
        ...
        "year": "2025",
        "quarter": "Q3",
        "error": "OpenAI 推出了ChatGPT，并开发出GPT-4，使ChatGPT 成为最新的热门话题，以\n致涌现许多利用ChatGPT 的新创企业。（应改为“以至”）",
      ...
      },
      {
        ...
        "analysis": "《算数书》是中国早期数学著作，是1983 年底至1984 年初在湖北江陵(今荆州)张家山\n247 号汉墓中出土的一批数学竹简，约190 支完好，因其中的一支有“算数书”三字而得名。 \n二、表述不准确",
        "highlighted_words": [
          "《算数书》"
        ]
      },
  ...
  },
  {
    ...
    "entries": [
      ...
      },
      {
        ...
        "quarter": "Q3",
        "error": "",
        "analysis": "人名拼写有误。案例中的Christain 正确拼写为Christian。革兰氏染色法是以丹麦医生、\n细菌学家Hans Christian Joachim Gram 的姓氏命名的，其姓名通常简写为H. C. J. Gram。 \n二、知识性差错",
        "highlighted_words": []
      },
      {
        "id": "2-11",
        ...
        "quarter": "Q3",
        "error": "",
        "analysis": "计算有误。PPI 指每英寸像素数，即图像中每英寸长度内包含的像素点数量。计算图\n像的总像素数时，高度和宽度的PPI 是相同的，案例中都为300。 \n~ 5 ~",
        "highlighted_words": []
      },
      {
        "id": "2-12",
      ...
      },
      {
        ...
        "quarter": "Q3",
        "error": "",
        "analysis": "公式有误。案例中p 和q 分别代表成功（k 取1）和失败（k 取0）的概率（0~1 之间\n的数值），k 和1−k 是指数，不是下标。",
        "highlighted_words": []
      },
      {
        "id": "2-2",
      ...
      },
      {
        ...
        "quarter": "Q3",
        "error": "",
        "analysis": "术语的英文注释有误。prompt injection attack 对应的中文是“提示注入攻击”，位置有\n误，应前移至中文术语后。",
        "highlighted_words": []
      },
      {
        "id": "2-4",
      ...
      },
      {
        ...
        "quarter": "Q3",
        "error": "",
        "analysis": "漏字。关键字是计算机语言里事先定义的、有特别意义的标识符。案例中的def 是Python\n中用于定义函数的关键字。",
        "highlighted_words": []
      },
      {
        "id": "2-7",
      ...
      },
      {
        ...
        "quarter": "Q4",
        "error": "",
        "analysis": "题目中数值有误。例中已知p2=0.006MPa，解题时按p2=0.06MPa 计算，故宜将题干中\n的p2值改为0.06MPa。",
        "highlighted_words": []
      },
      {
        "id": "2-12",
        ...
        "quarter": "Q4",
        "error": "",
        "analysis": "数字有误。例中(10, $) = r4 的意思是：当分析器处于状态10 且下一个前看记号是$时，\n执行归约动作，使用的是第4 个产生式。显然，对应状态12，应为(12, $)= r4。",
        "highlighted_words": []
      },
      {
        "id": "2-13",
      ...
      },
      {
        ...
        "quarter": "Q4",
        "error": "",
        "analysis": "计算过程有误。例中PSI 的计算有误，自然对数ln 0.5 为负数（ln x 在0＜x＜1 时为负，\nx＞1 时为正，x＜0 时无意义），代入PSI 的算式应为“－1%×（－0.6931）≈0.0069”。",
        "highlighted_words": []
      },
      {
        "id": "2-3",
      ...
      },
      {
        ...
        "quarter": "Q4",
        "error": "",
        "analysis": "标准名称有误。GB/T 22083—2008 的名称是《建筑密封胶分级和要求》。",
        "highlighted_words": []
      },
      {
        "id": "2-9",
        ...
        "quarter": "Q4",
        "error": "",
        "analysis": "标准混淆。例中混淆了世界卫生组织推荐的成人BMI 标准与我国成人BMI 标准。我国\n成人BMI 标准是原国家卫生和计划生育委员会于2013 年4 月发布的《成人体重判定》（WS/T 428\n—2013），与世界卫生组织推荐标准存在差异。 \n二、数值（数字）差错",
        "highlighted_words": []
      }
    ],
    "total": 72
    ...
    "entries": [
      {
        ...
        "year": "2025",
        "quarter": "Q3",
        "error": "The outcome is highly promising and suggest that walking itself may bolster our \nimaginative thinking. （应改为suggests）",
        "analysis": "本句中，and 连接了两个并列谓语。根据主谓一致原则，单数主语the outcome 对应的\n谓语动词也应该是单数形式。因此，第二个动词suggest 应改为suggests。",
        "highlighted_words": []
      },
      {
        "id": "3-2",
        "year": "2025",
        "quarter": "Q3",
        "error": "Student-centered learning methods have fostered a system of qualitative good teaching that \nbalances academic rigor with holistic development. （应改为qualitatively）",
        "analysis": "句子中的qualitative 为形容词，不能直接修饰同样为形容词的good。修饰形容词需用\n副词，所以要将qualitative 改为qualitatively。",
        "highlighted_words": []
      },
      {
        "id": "3-3",
        "year": "2025",
        "quarter": "Q3",
        "error": "Concerns have been raising that pollution is found in every marine ecosystem. （应改为\nraised）",
        "analysis": "句子的主语concerns 是动作的承受者，而非动作的发出者，因此需用被动语态，将原\n句中的 raising 修改为 raised。",
        "highlighted_words": []
      },
      {
        "id": "3-4",
        "year": "2025",
        "quarter": "Q3",
        "error": "Experts discussed lively about the impact of digital currency on traditional finance.（应改\n为There was a lively discussion among experts）",
        "analysis": "lively 并非副词，而是一个形容词，意思是“活泼的；充满活力的”，不能用来修饰动\n词discuss。修改时，可以变换句子结构，使之符合语法规则。 \n二、文字差错",
        "highlighted_words": []
      },
      {
        "id": "3-5",
        "year": "2025",
        "quarter": "Q3",
        "error": "They kept talking when they were waiting for their luggages. （应改为luggage）",
        "analysis": "luggage 意为“行李”，在英语中是不可数名词，无论指几件行李，都不能加“-s”变\n为复数。若需强调行李的数量，可搭配量词使用，如 a piece of luggage（一件行李）、two pieces of \nluggage（两件行李）。",
        "highlighted_words": []
      },
      {
        "id": "3-6",
        "year": "2025",
        "quarter": "Q3",
        "error": "This river’s water pollution level is similar with that of other urban waterways. （应改为\nto）",
        "analysis": "本句的错误为介词误用。在英语中，与similar 搭配的固定介词是to，而非with，即be \nsimilar to（与……相似）是唯一正确的表达。",
        "highlighted_words": []
      },
      {
        "id": "3-7",
        "year": "2025",
        "quarter": "Q3",
        "error": "Scientists have created a new devise that uses sensors to track soil moisture levels for smart \nfarming. （应改为device）",
        "analysis": "devise 和device 的拼写相似，经常被混淆，但词性和意思完全不同。device 是名词，\n意为“设备”；devise 是动词，意为“设计”。",
        "highlighted_words": []
      },
      {
        "id": "3-1",
        "year": "2025",
        "quarter": "Q4",
        "error": "It’s a connectionless protocol that used primarily for broadcasting messages over a network. \n（应改为that is used）",
        "analysis": "描述事物的用途或性质时，若主语是行为的接受者，需使用被动语态，所以将that used\n改为that is used。",
        "highlighted_words": []
      },
      {
        "id": "3-2",
        "year": "2025",
        "quarter": "Q4",
        "error": "FTP is a standard network protocol used exchanging files over the Internet. （应改为used \nfor）",
        "analysis": "used for doing something 为固定搭配，意为“被用于做某事”；used for exchanging 是\n省略了which is 的过去分词短语，作protocol 的后置定语。",
        "highlighted_words": []
      },
      {
        "id": "3-3",
        "year": "2025",
        "quarter": "Q4",
        "error": "A computer network is a collection of computers and devices interconnected by \ncommunication channels that facilitate communications among users and allows users to share resources. \n（应改为allow）",
        "analysis": "原句为定语从句，关系代词that 指代的先行词communication channels 是复数形式，\n因此从句的两个并列谓语动词也需保持复数形式。facilitate 的形式正确；allows 为单数形式，应改为\n复数形式allow。",
        "highlighted_words": []
      },
      {
        "id": "3-4",
        "year": "2025",
        "quarter": "Q4",
        "error": "IEEE 802.11 and IEEE 802.11x refers to a family of specifications developed by the IEEE \nfor wireless LAN technology. （应改为refer）",
        "analysis": "句子主语IEEE 802.11 and IEEE 802.11x 是两个并列的名词短语，表示复数概念，因此\n谓语动词需用复数形式 refer，原句的单数形式 refers 不符合语法规则。 \n二、文字差错",
        "highlighted_words": []
      },
      {
        "id": "3-5",
        "year": "2025",
        "quarter": "Q4",
        "error": "Two of the best lines were: “Best-clouds swallow the sinking sun. And the bow-moon \nshoots the falling stars.” （应改为Beast）",
        "analysis": "本句是引用林语堂所译《浮生六记》中的文字。初读似有不妥，经过查验，原文为“兽\n云吞落日，弓月弹流星”。由此可见，Best 为Beast 的笔误。",
        "highlighted_words": []
      },
      {
        "id": "3-6",
        "year": "2025",
        "quarter": "Q4",
        "error": "Our lord is too kind-heated a man. （应改为hearted）",
        "analysis": "kind-heated 为拼写错误。heat 表热量，语义不通。kind-hearted 是复合形容词，意为\n“心地善良的”。本句的语序比较特殊，当程度副词too + adj.修饰单数可数名词时，必须用“too + \nadj. + a/an +单数名词”的结构。 \n~ 7 ~ \n \n2025 年外语类图书中的错误主要集中在如下几个方面。 \n（1）文字差错：英文单词拼写、正斜体、大小写错误，固定搭配中介词误用。 \n（2）语法差错：词性误用，代词误用，主谓不一致，句子成分残缺或搭配不当，被\n动语态误用，并列结构不一致，定语从句错误。 \n（3）知识性差错：讲解及注释错误，术语翻译不准确，习题无逻辑，习题答案错。 \n（4）涉政表述不严谨，照搬西方学术理论，传播西方价值观。",
        "highlighted_words": []
      },
      {
        "id": "3-7",
        "year": "2025",
        "quarter": "Q4",
        "error": "But it was not wine that attached him to this apot. It was the charming scenery, which wine \nenabled him to enjoy. （应改为spot）",
        "analysis": "英文中并无apot 这个单词。经过分析，原句要表达的意思是“醉翁之意不在酒”，apot\n是spot 的笔误。spot 在英文中侧重“特定的、较小的具体地点”，与原文里“亭边饮酒、赏景”的\n场景高度契合。",
        "highlighted_words": []
      }
    ],
    "total": 14
    ...
    "entries": [
      {
        ...
        "year": "2025",
        "quarter": "Q3",
        "error": "人名错误，綦毋怀文，中国南北朝时期的著名冶金家，宿铁刀的发明者。",
        "analysis": "",
        "highlighted_words": []
      },
      {
      ...
      },
      {
        ...
        "year": "2025",
        "quarter": "Q3",
        "error": "概念性差错，蓝色圈中的“解码者”和“编码者”说法反了。",
        "analysis": "",
        "highlighted_words": []
      },
      {
        ...
        "year": "2025",
        "quarter": "Q3",
        "error": "年份错误，明正统元年是1436 年，正统四年应为1439 年。",
        "analysis": "",
        "highlighted_words": []
      },
      {
        ...
        "year": "2025",
        "quarter": "Q3",
        "error": "题目选项错误，A 和C 选项本质一样，C 和D 选项相同。",
        "analysis": "",
        "highlighted_words": []
      },
      {
        ...
        "year": "2025",
        "quarter": "Q3",
        "error": "数值和单位错误，2.4 亿吨应为24 亿吨，4 万亿吨应为40 亿吨。 \n \n二、程序差错",
        "analysis": "",
        "highlighted_words": []
      },
      {
      ...
      },
      {
        ...
        "year": "2025",
        "quarter": "Q4",
        "error": "2025 年末，世界范围内人口上亿的国家有16 个。",
        "analysis": "",
        "highlighted_words": []
      },
      {
      ...
      },
      {
        ...
        "year": "2025",
        "quarter": "Q4",
        "error": "红框中“先进轨道交通装备”与前面内容重复，应为“节能与新能源汽车”。",
        "analysis": "",
        "highlighted_words": []
      },
      {
        ...
        "year": "2025",
        "quarter": "Q4",
        "error": "6.4 节题下的文字与6.5 节相同，应为“图像作用”的相关内容。",
        "analysis": "",
        "highlighted_words": []
      },
      {
      ...
      },
      {
        ...
        "year": "2025",
        "quarter": "Q4",
        "error": "图中“震”与“艮”的图形相同，“艮”的图形有误，应为☶。 \n \n五、序号差错",
        "analysis": "",
        "highlighted_words": []
      },
      {
      ...
      },
      {
        ...
        "year": "2025",
        "quarter": "Q4",
        "error": "序号中直接出现2）。 \n \n \n \n附：2025 年样书速查典型问题 \n一、封扉权问题 \n1. CIP 与封扉著作方式不一致，如CIP 是主编，封扉是编著； \n2. 扉页缺少出版地“北京”； \n3. CIP 数据格式欠规范； \n4. 封扉英文书名字母大小写错，外籍作者中译名格式错等； \n5. 封面宣传语存在语法、标点、文字等差错。 \n二、辅文问题 \n1. 全书书眉书名错，如少字、英文单词错误等； \n2.《党的二十大报告》引文差错；  \n3. 目录存在文字、格式差错；  \n4. 文前彩页存在文字差错。 \n三、正文问题 \n1. 书中选用的设计作品不合适； \n2. 二维码说明文字与二维码扫码内容不符； \n3. AI 生成图存在文字乱码、肢体畸形等；  \n4. 地图使用不规范； \n5. 截图中存在不雅表述。",
        "analysis": "",
        "highlighted_words": []
      },
      {
      ...
      },
      {
        ...
        "year": "2025",
        "quarter": "Q4",
        "error": "mg/d 应为μg/d，1mg（毫克）=1000μg（微克）。",
        "analysis": "",
        "highlighted_words": []
      },
      {
